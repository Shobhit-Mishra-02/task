  ...
  return (
    <div className="signup_page">
      <div className="login_cover">
        ...
        <div className="cover__image_container">
          <img src="/loginCover.svg" alt="cover image" />
        </div>
        <div className="cover_author">
          <p>
            Art by <span>Peter Tarka</span>
          </p>
        </div>
      </div>
      <div className="form_container">
        <div className="form__account_message">
          <p>
        ...
        <form className="signup_form">
          ...
          <div className="form__submit_btn_container">
