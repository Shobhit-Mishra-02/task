...
function MobileSearch() {
  return (
    <div className="mobile__search_container">
  ...
  return (
    <nav className="navbar">
      <div className="section__container">
        <div className="navbar__left_section">
          <span className="navbar__menu_icon">
            <svg
          ...
          <span className="navbar__logo_container">
            <svg
              width="2500"
              height="615"
              viewBox="0 0 512 126"
          ...
          <ul className={`menu_mobile ${toggle ? "" : "menu__hide"}`}>
            <div className="menu__exit_btn_container">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <div className="menu__image_container">
        ...
        <div className="navbar__right_section">
          <span className="">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
