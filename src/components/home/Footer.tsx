  ...
  return (
    <footer>
      <div className="footer__sections">
        <div className="footer__left_section">
          ...
          <p>
            ...
            officiis, hic natus reprehenderit architecto.
          </p>
      ...
      <div className="footer__bottom">
        <p className="footer__bottom_left">
          @2023 Dribbble. All rights reserved.
        </p>

        <p className="footer__bottom_right">
          <span>20,5000</span>
          shots dribble design
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
